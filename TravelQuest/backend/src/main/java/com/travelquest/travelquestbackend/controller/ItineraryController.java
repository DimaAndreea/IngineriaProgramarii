...
public class ItineraryController {
    ...
    // ===========================
    // GUIDE — ACTIVE ITINERARY PARTICIPANTS
    // ===========================
    @GetMapping("/active/{itineraryId}/participants")
    public List<ActiveItineraryParticipantDto> getActiveItineraryParticipants(
        ...
        if (user == null || !"GUIDE".equals(user.getRole().name())) {
            throw new RuntimeException("Only guides can view participants.");
        }

        return service.getActiveItineraryParticipants(itineraryId, user);
    }
