            ...
            <div className="register-content">
                ...
                <div className="brand-content">
                    ...
                    <div className="tagline-section">
                        <h2 className="main-tagline">Start Your Journey</h2>
                        <h2 className="main-tagline highlight">With TravelQuest</h2>
                        <p className="tagline-description">
                            Join our community of travelers and guides. Create your account
                            and unlock exclusive itineraries and experiences.
                        </p>
                    </div>
                </div>
                ...
                <div className="form-content">
                    <div className="form-container">
                        <div className="form-header">
                            ...
                            <p className="form-subtitle">Select your role and fill in your details</p>
                        </div>
                        <RegisterForm />
                    </div>
                </div>
